      ...
      groups: [
        {
          items: [
            ...
            },
            {
              ...
              href: "/addiction/drug/",
              subLinks: [
                { label: "Cannabis addiction",      href: "/addiction/drug/cannabis/" },
                { label: "Cocaine addiction",       href: "/addiction/drug/cocaine/" },
                ...
                { label: "Hallucinogen addiction",  href: "/addiction/drug/hallucinogens/" },
                { label: "Heroin addiction",        href: "/addiction/drug/heroin/" },
                { label: "Inhalant addiction",      href: "/addiction/drug/inhalants/" },
                { label: "Ketamine addiction",      href: "/addiction/drug/ketamine/" },
                { label: "LSD addiction",           href: "/addiction/drug/lsd/" },
                { label: "Monkey dust addiction",   href: "/addiction/drug/monkey-dust/" },
                { label: "Steroid addiction",       href: "/addiction/drug/steroids/" },
              ],
            },
            {
              icon: Leaf,
